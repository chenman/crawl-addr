...
public class AddrCrawlThread implements Runnable {
	private Long minId;
	private Long maxId;

	public AddrCrawlThread(Long minId, Long maxId) {
		this.minId = minId;
		this.maxId = maxId;
	}
	...
	public void run() {
		...
		// Long id = 110000000080000L;
		Long id = this.minId;
		DBUtil dbUtil = new DBUtil();
		String systemId;
		// while (id < 110000000100000L) {
		while (id < this.maxId) {
			systemId = String.format("350300%015d", id);
